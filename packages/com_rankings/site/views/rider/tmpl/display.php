...
{ ?>
    <div class="tt-rider-heading">
        ...
        <div class="tt-rider-category hillclimbs">
            ...
            <?php /*if (in_array($this->rider->hc_status, array('Frequent rider','Qualified','Provisional'), true ))*/ if ($this->rider->hc_status !== "Lapsed")
            { ?>
    ...
    <?php if (count($this->rider->tt_rides + $this->rider->hc_rides) > 0)
    { ?>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="timetrials">
                    <div class="tt-nav-tab-content">
                        <?php if (count($this->rider->tt_rides) == 0)
                        { ?>
                        ...
                        <?php
                            ...
                            <div class="tt-tab-panel">
                                ...
                                <tbody>
                                    <?php for($i=0, $n = count($this->rider->tt_rides); $i<$n; $i++) 
                                    {
                                        $this->_ridesListView->ride = $this->rider->tt_rides[$i];

                                        If (($i==0) or ($i>0 && date('Y', strtotime($this->rider->tt_rides[$i]->event_date)) != date('Y', strtotime($this->rider->tt_rides[$i-1]->event_date))))
                                        { ?>
                                        ...
                                        <tr class="row<?php echo $i % 2; ?> tt-rankings-<?php if ($this->_ridesListView->ride->counting_ride_ind) { echo "counting-ride";} else { echo "non-counting-ride";} ?>">
                                            ...
                                            <td class="tt-col-ride-distance visible-desktop"><?php if($this->_ridesListView->ride->duration_event_ind)
                                                {
                                                    echo abs($this->_ridesListView->ride->distance) . ' hours';
                                                } else {
                                                    echo abs($this->_ridesListView->ride->distance) . ' miles';
                                                } ?></td>
                                            <td class="tt-col-ride-distance hidden-desktop"><?php if($this->_ridesListView->ride->duration_event_ind)
                                                {
                                            ...
                                            <td class="tt-col-ride-result hidden-phone"><?php if($this->_ridesListView->ride->duration_event_ind)
                                                {
                ...
                <div role="tabpanel" class="tab-pane" id="hillclimbs">
                    <div class="tt-nav-tab-content">
                        <?php if (count($this->rider->hc_rides) == 0)
                        { ?>
                            <div class="tt-list-heading">
                                <div class="tt-list-title">
                                    <h2><?php echo "No results since 1st January 2017"; ?></h2>
                        ...
                        <?php
                            ...
                            <div class="tt-tab-panel">
                                ...
                                <tbody>
                                    <?php for($i=0, $n = count($this->rider->hc_rides); $i<$n; $i++) 
                                    {
                                        $this->_ridesListView->ride = $this->rider->hc_rides[$i];

                                        If (($i==0) or ($i>0 && date('Y', strtotime($this->rider->hc_rides[$i]->event_date)) != date('Y', strtotime($this->rider->hc_rides[$i-1]->event_date))))
                                        { ?>
                                            <tr class="tt-table-year-row">
                                                <td colspan="6"><?php echo date('Y', strtotime($this->_ridesListView->ride->event_date)); ?></td>
                                            </tr>
                                        ...
                                        <tr class="row<?php echo $i % 2; ?> tt-rankings-<?php if ($this->_ridesListView->ride->counting_ride_ind) { echo "counting-ride";} else { echo "non-counting-ride";} ?>">
                                            ...
                                            <td class="tt-col-ride-distance visible-desktop"><?php if($this->_ridesListView->ride->distance > 0)
                                                {
                                                    echo abs($this->_ridesListView->ride->distance) . ' miles';
                                                } else {
                                                    echo '-';
                                            ...
                                            <td class="tt-col-ride-distance hidden-desktop"><?php if($this->_ridesListView->ride->distance > 0)
                                                {
                                                    echo abs($this->_ridesListView->ride->distance);
                                                } else {
                                                    echo '-';
                                            ...
                                            <td class="tt-col-ride-position hidden-phone"><?php echo $this->_ridesListView->ride->position; ?></td>
                                            <td class="tt-col-ride-result hidden-phone"><?php 
                                                    echo $this->_ridesListView->ride->time; ?></td>
                                            <td class="tt-col-rider-ride-points"><?php echo $this->_ridesListView->ride->ranking_points; ?><i class="fa fa-<?php echo $this->_ridesListView->ride->improved_ride; ?>"></i></td>
                                        </tr>
                                    <?php
                                    } ?>
                                        ...
                                        <?php 
                                            ...
                                            <tr>
                                                ...
                                                { ?>
                                                    ...
                                                    <td class="tt-col-ride-distance visible-desktop" rowspan="<?php echo $event_award_count; ?>"><?php if($this->_awardsListView->award->duration_event_ind)
                                                    {
                                                        echo abs($this->_awardsListView->award->distance) . ' hours';
                                                    } else {
                                                        if ($this->_awardsListView->award->distance > 0)
                                                        {
                                                    ...
                                                    <td class="tt-col-ride-distance hidden-desktop" rowspan="<?php echo $event_award_count; ?>"><?php if($this->_awardsListView->award->duration_event_ind)
                                                    {
