				...
				<tbody>
					...
					<?php foreach($this->awards as $i => $award) : ?>
						...
						<?php else : ?>
							<?php $newEvent = false; ?>
						<?php endif; ?>
						<?php if (($i == 0) or ($i > 0 && date('Y', strtotime($award->event_date)) != date('Y', strtotime($this->awards[$i-1]->event_date)))): ?>
					...
					<tr>
						<td colspan="5">
							<div class="tt-table-counters">
								<div class="tt-pages-counter pull-left"><?php echo $this->awardsPagination->getPagesCounter(); ?></div>
								<div class="tt-results-counter pull-right"><?php echo $this->awardsPagination->getResultsCounter(); ?></div>
							</div>
							<div class="pagination tt-pagination"><?php echo $this->awardsPagination->getPagesLinks(); ?></div>
						</td>
					</tr>
				</tfoot>
			</table>
