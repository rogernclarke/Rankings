...
foreach ($this->hcriderhistories as $riderhistory)
{
...
<script>
	...
	document.addEventListener('DOMContentLoaded', function () {
		var hcoptions = {
			chart: {
				renderTo: 'hcrides-chart-container'
			},
			title: {
				text: 'Hill Climb Performance - <?php echo "$year"; ?>'
			},
			xAxis: {
				type: 'datetime',
		...
		<?php endif; ?>
		var chartHc = new Highcharts.Chart(hcoptions);
	});
</script>
