...
<table class="tt-table">
	<thead>
		<tr>
            ...
            <th class="tt-modtt-col-total-score"><?php echo JText::_('COM_RANKINGS_TOTAL_SCORE'); ?></th>
        </tr>
	</thead>
	<tbody>
    	...
    	{ ?>
    		<tr class="row<?php echo $i % 2; ?>">
				...
				<td class="tt-modtt-col-club-name"><?php echo $teams[$i]->club_name; ?></a></td>
                <td class="tt-modtt-col-total-score"><?php echo $teams[$i]->total_score; ?></td>
    		</tr>
    	<?php
    	} ?>
    </tbody>       
